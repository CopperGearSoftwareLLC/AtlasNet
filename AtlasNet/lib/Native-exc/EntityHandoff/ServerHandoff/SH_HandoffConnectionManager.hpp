...
class SH_HandoffConnectionManager : public Singleton<SH_HandoffConnectionManager>
{
  public:
	SH_HandoffConnectionManager() = default;
  ...
  private:
	...
	std::unique_ptr<SH_HandoffConnectionLeaseCoordinator> leaseCoordinator;
};
