...
services:
  ${WATCHDOG_SERVICE_NAME}:
    ...
    environment:
      ...
      - ATLASNET_LLM_ENDPOINT=${ATLASNET_LLM_ENDPOINT:-http://${ATLASNET_LLM_DOCKER_HOST:-172.17.0.1}:${ATLASNET_LLM_DOCKER_PORT:-12434}/v1/chat/completions}
      - ATLASNET_LLM_DOCKER_HOST=${ATLASNET_LLM_DOCKER_HOST:-172.17.0.1}
      - ATLASNET_LLM_DOCKER_PORT=${ATLASNET_LLM_DOCKER_PORT:-12434}
