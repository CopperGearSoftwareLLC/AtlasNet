...
async function CartographViewerModule(moduleArg = {}) {
  var moduleRtn;
...
function findWasmBinary() {
  ...
  if (Module['locateFile']) {
    return locateFile('CartographViewer.wasm');
  }

  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('CartographViewer.wasm', import.meta.url).href;
...
export default CartographViewerModule;
