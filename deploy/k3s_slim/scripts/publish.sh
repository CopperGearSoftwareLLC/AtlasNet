...
for key in IMAGE_REPO IMAGE_TAG IMAGE_PLATFORMS BUILD_DIR BAKE_FILE BUILDER_NAME WITH_LATEST_TAG; do
...
echo "Recorded last published tag in ${TAG_RECORD_FILE}"
