...
public:
  ...
  template <typename T> void write_any(const T& v)
  {
  ...
  template <typename T> ByteWriter& operator()(T& v)
  {
    write_any(v);
    return *this;
  }

  template <typename... Args> ByteWriter& operator()(Args&&... args)
  {
    (write_any(args), ...);
    return *this;
  }
