...
public:
  ...
  ByteReader &vec2(glm::vec2 &v) { return read_vector<2>(v); }
  ByteReader &vec3(glm::vec3 &v) { return read_vector<3>(v); }
  ByteReader &vec4(glm::vec4 &v) { return read_vector<4>(v); }

  ByteReader &ivec2(glm::ivec2 &v) { return read_vector<2>(v); }
  ByteReader &ivec3(glm::ivec3 &v) { return read_vector<3>(v); }
  ByteReader &ivec4(glm::ivec4 &v) { return read_vector<4>(v); }
